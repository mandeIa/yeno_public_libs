...
function library:Load(options)
    ...
    function window_types:SettingsTab(watermark, unload)
        ...
        local misc = settings:Section{name = "Menu Configurate", Side = "right"}
...
local watermark = library:Watermark("yeno | dev | test | 2.3b fps")
